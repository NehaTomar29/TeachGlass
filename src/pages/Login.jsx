  ...
  return (
    ...
    >
      <Button
        type="button"
        variant="outline"
        className="w-full h-12 text-sm font-medium mb-6 flex items-center justify-center border-slate-200 hover:bg-slate-50"
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <Button
          type="submit"
          className="w-full h-12 font-medium bg-indigo-600 hover:bg-indigo-700 text-white"
          disabled={loading}
        >
          {loading ? (
            <>
